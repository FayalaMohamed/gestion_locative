...
def upgrade() -> None:
    ...
    op.create_table('contrats',
        ...
        sa.Column('est_resilie', sa.Boolean(), nullable=True),
        sa.Column('date_resiliation', sa.Date(), nullable=True),
        sa.Column('motif_resiliation', sa.Text(), nullable=True),
        sa.Column('conditions', sa.Text(), nullable=True),
        sa.Column('created_at', sa.DateTime(), nullable=True),
        sa.Column('updated_at', sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(['locataire_id'], ['locataires.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id')
    )
...
def downgrade() -> None:
    ...
    # Note: SQLite doesn't support DROP TYPE, so we skip these
